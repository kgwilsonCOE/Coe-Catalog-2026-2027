...
\item
  +++MISSING INFO: c.avs201\_201L.long +++
\item
...
\item
  BUS 472 Advanced Topics in Finance (if the topic is substantially
  different from when taken to fulfill requirement \#2)
\end{itemize}
...
\item
  One course with an international focus outside of the department, with
...
\item
  A capstone project in international business, supervised by a business
  faculty member
\item
  An internship in international business, supervised by a business
  faculty member
\end{itemize}
...
\item
  BUS 454 Research in Business (when topic is appropriate to Risk
  Management/Insurance concentration)
\item
  BUS 494 Internship in Business (when internship is appropriate to Risk
  Management/Insurance concentration)
\item
  BUS 495 Investment Analysis
\end{itemize}
...
\tightlist
\item
  \textbf{One} of the following data analysis courses:
\end{enumerate}
...
\tightlist
\item
  \textbf{One} of the following global strategy courses:
\end{enumerate}
